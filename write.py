...
def save(mensaje, ruta_imagen_original, ruta_imagen_salida):
	...
	if contador >= longitud:
		messagebox.showinfo(message="Mensaje escrito correctamente", title="Exito")
	else:
		messagebox.showinfo(message="Advertencia: no se pudo escribir todo el mensaje, sobraron {} caracteres".format( math.floor((longitud - contador) / 8)), title="Advertencia")
